            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <DropdownMenu.Root>
                <DropdownMenu.Trigger asChild>
                  <button className="inline-flex items-center gap-2 px-5 py-4 bg-slate-700 hover:bg-slate-600 text-slate-200 rounded-xl transition-colors">
                ...
                <DropdownMenu.Portal>
                  <DropdownMenu.Content
                    align="start"
                    sideOffset={4}
                    className="z-20 bg-slate-800 border border-slate-700 rounded-xl shadow-2xl py-2 min-w-[180px] focus:outline-none"
                  >
                    {collections.map((col) => {
                      ...
                      return (
                        <DropdownMenu.CheckboxItem
                          ...
                          onCheckedChange={(checked) => {
                            if (checked) addToCollection(col.id, book);
                            else removeFromCollection(col.id, book.id);
                          }}
                          className="flex items-center gap-3 px-4 py-2.5 text-sm cursor-pointer hover:bg-slate-700 transition-colors focus:outline-none focus:bg-slate-700"
                        >
